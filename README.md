...
The repository is currently in **Phase 5: deterministic risk, validation, and
bounded comparison**. It builds on the consent-first project, capture and
...
server-owned deterministic R1 decision with no unresolved assumptions. Physical
output, approval, export, and professional-safety workflows remain deferred.
