...
ALLOWED_TRANSITIONS: dict[str, set[str]] = {
    ...
    "risk_review": {"ready_for_generation", "blocked_out_of_scope", "deleted"},
    "ready_for_generation": {"generating", "deleted"},
    "generating": {"candidates_ready", "cancelled", "deleted"},
    ...
    "blocked_out_of_scope": {"deleted"},
    "needs_more_information": {"consented", "captured", "deleted"},
    "cancelled": {"deleted"},
    "deleted": set(),
}
